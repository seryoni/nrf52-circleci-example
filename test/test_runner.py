...
class TestAppButton(unittest.TestCase):
    ...
    def test_led_should_turn_on_on_button_push(self):
        ...
        # expected: led on after long push on button
        self.assertEqual(self.vlab.get_pin_level(17), 0)  # in this case we are going to poll for the pin level
    ...
    def test_should_ignore_button_noise(self):
        ...
        # expected: led off after short push on button
        self.assertEqual(self.vlab.get_pin_level(17), 1)  # in this case we are going to poll for the pin level
