    ...
    #define BME280_INSTANCE_ID 1
    #define BME280_ADDRESSES 0x76U // connection to V-DDIO
    // #define CONFIG 0xf3U
    #define CTRL_MEAS 0xf4U
    #define CTRL_HUM 0xf2U
    #define MODE_AND_OVERSAMPLING 0x25U
    #define INACTIVE_DURATION_AND_FILTER 0x40U
    #define HUMADITY_OVERSAMPLE 0x1U
    #define REG_ADDRESS 0xf7U
    #define END_OF_MEM_MAP 0xfeU
    #define BME280_SCL_PIN 27
    #define BME280_SDA_PIN 26
    #define PACKET_TYPE_START 1
    
    /* BME280 instance. */
    static const nrf_drv_twi_t m_twi = NRF_DRV_TWI_INSTANCE(BME280_INSTANCE_ID);
...
//    static void log_pin(const struct bme280_calib_data *calib_data) {
//
//        NRF_LOG_DEBUG("\r\nCheck ADG1404 Start!\r\n");
//        NRF_LOG_DEBUG("calib_data->t_fine [%d]\r\n", calib_data->t_fine);
//        NRF_LOG_DEBUG("calib_data->dig_H1 [%d]\r\n", calib_data->dig_H1);
//        NRF_LOG_DEBUG("calib_data->dig_H2 [%d]\r\n", calib_data->dig_H2);
//        NRF_LOG_DEBUG("calib_data->dig_H3 [%d]\r\n", calib_data->dig_H3);
//        NRF_LOG_DEBUG("calib_data->dig_H4 [%d]\r\n", calib_data->dig_H4);
//        NRF_LOG_DEBUG("calib_data->dig_H5 [%d]\r\n", calib_data->dig_H5);
//        NRF_LOG_DEBUG("calib_data->dig_H6 [%d]\r\n", calib_data->dig_H6);
//
//        NRF_LOG_FLUSH();
//    }
...

    {
        ...
        rslt = my_i2c_tx(dev_id, &reg_addr, 1);
        if (rslt == 0) {
            my_i2c_rx(dev_id, reg_data, len);
        }
    ...
    int8_t user_i2c_write(uint8_t dev_id, uint8_t reg_addr, uint8_t *reg_data, uint16_t len)
    {
        ...
        my_i2c_tx(dev_id, reg_addr_and_data, len + 1);
        /*
         * The parameter dev_id can be used as a variable to store the I2C address of the device
         */
    ...
    int8_t stream_sensor_data_forced_mode(struct bme280_dev *dev)
    {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            dev->delay_ms(250); //wait for data generator
        }
        return rslt;
    }
    ...
    void twi_init (void)
    {
        ...
        err_code = nrf_drv_twi_init(&m_twi, &bme280_config, bme_handler, NULL);
        APP_ERROR_CHECK(err_code);
